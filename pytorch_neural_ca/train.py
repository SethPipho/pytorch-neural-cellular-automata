...
from pytorch_neural_ca.util import generate_initial_state, state_to_image, render_test_video, value_noise
...
def train_ca(model, 
    ...
    while epoch < epochs:
        ...
        if epoch % sample_every == 0 and epoch != 0:
            ...
            render_test_video(model, path, width, height, verbose=False)
